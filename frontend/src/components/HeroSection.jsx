...
export const HeroSection = () => {
  ...
  return (
    <section
      ...
      style={{
        background: isDark
          ? "linear-gradient(135deg, #0f172a 0%, #1e1530 30%, #0f172a 70%, #0f172a 100%)"
          : "linear-gradient(135deg, #ffffff 0%, #FFF7F3 30%, #F8FAFC 70%, #ffffff 100%)",
      }}
    >
      {/* Subtle dot grid */}
      <div
        ...
        style={{
          backgroundImage: `radial-gradient(circle, ${isDark ? "rgba(255,255,255,0.8)" : "#1B2A4A"} 1px, transparent 1px)`,
      ...
      <div
        ...
        style={{
          background: isDark ? "rgba(99,155,255,0.05)" : "rgba(186,230,253,0.45)",
          animation: "dashFloat 13s ease-in-out 2s infinite reverse",
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-20 sm:pt-32 pb-12 sm:pb-20 w-full">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <h1
              className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-navy dark:text-white leading-[1.15] tracking-tight mb-4 sm:mb-6"
            ...
            <p
              className="text-base sm:text-lg lg:text-xl text-slate-500 dark:text-slate-400 max-w-2xl mb-8 sm:mb-10 leading-relaxed"
            ...
            >
              ...
              <Button
                ...
                className="w-full xs:w-auto border-2 border-slate-200 dark:border-slate-600 text-navy dark:text-slate-100 font-semibold px-6 sm:px-8 py-3 sm:py-6 text-sm sm:text-base rounded-full hover:border-coral hover:text-coral dark:hover:border-coral dark:hover:text-coral transition-all duration-300 hover:-translate-y-1 bg-transparent dark:bg-transparent"
              >
          ...
          >
            {/* Main Dashboard Card */}
            <div
              className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-100 dark:border-slate-700 p-5 w-[270px] sm:w-[310px]"
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-[11px] bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400 px-2 py-0.5 rounded-full font-semibold flex items-center gap-1">
                  <span
              ...
              <div className="flex justify-between text-[10px] text-slate-300 dark:text-slate-600 mb-4 px-1">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-slate-50 dark:bg-slate-700 rounded-xl p-2.5">
                  <div className="text-[10px] text-slate-400 dark:text-slate-500 mb-0.5">Reach</div>
                  <div className="text-sm font-bold text-navy dark:text-white">48.2K</div>
                </div>
            ...
            <div
              className="absolute top-10 right-3 sm:right-0 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-100 dark:border-slate-700 px-3 py-2 flex items-center gap-2"
            ...
            >
              ...
              <div>
                <div className="text-[10px] text-slate-400 dark:text-slate-500">Clicks</div>
                <div className="text-sm font-bold text-navy dark:text-white">12.5K</div>
              </div>
            </div>

            {/* Floating Badge — Audience (bottom-left) */}
            <div
              className="absolute bottom-12 left-3 sm:left-0 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-100 dark:border-slate-700 px-3 py-2 flex items-center gap-2"
            ...
            >
              ...
              <div>
                <div className="text-[10px] text-slate-400 dark:text-slate-500">Audience</div>
                <div className="text-sm font-bold text-navy dark:text-white">94% Engaged</div>
              </div>
            </div>
